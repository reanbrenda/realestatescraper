...
urlpatterns = [
    ...
    path('properties/<int:pk>/patch/', views.patch_property, name='property-patch'),
    ...
    path('bot/scrapers/', views.list_bot_scrapers, name='bot-scrapers'),
    path('bot/run/', views.run_bot_scraper, name='run-bot-scraper'),
    path('bot/run-all/', views.run_all_bot_scrapers, name='run-all-scrapers'),
]
